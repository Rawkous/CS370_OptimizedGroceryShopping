...
def main():
    ...
    p_check.add_argument(
        "--items",
        required=True,
        help="Comma-separated list, e.g. 'banana,egg,bread'",
    )
    ...
    p_k_check.add_argument(
        "--items",
        required=True,
        help="Comma list, e.g. 'milk,eggs,bread'",
    )
